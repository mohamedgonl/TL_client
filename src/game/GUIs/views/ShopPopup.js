var ShopPopup = cc.Layer.extend({
        ...
        ctor: function () {
            ...
            categories.map(e => {
                ...
                cc.eventManager.addListener(clickEventListener(() => {
                    this.handleClickCategory(e.getName(), categoryNameString)
                }).clone(), e);
            })
        ...
        updateResourceInfo: function () {
            ...
            res_bar_gold.setString(Utils.numberToText(PlayerInfoManager.getInstance().getResource().gold));
            ...
            res_bar_elixir.setString(Utils.numberToText(PlayerInfoManager.getInstance().getResource().elixir));

            let res_bar_g = this._itemsWrapper.getChildByName("resource_bar_g");
            res_bar_g = res_bar_g.getChildByName("res_bar_string");
            res_bar_g.setString(Utils.numberToText(PlayerInfoManager.getInstance().getResource().gem));
