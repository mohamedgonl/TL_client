var NotEnoughResourcePopup = cc.Node.extend({
    ctor: function (amount, type, callback) {
        ...
        let price = new cc.LabelBMFont(Utils.numberToText(amount), res.FONT.SOJI["24"], 350, cc.TEXT_ALIGNMENT_CENTER);
        ...
        let gemCostLabel = new cc.LabelBMFont("Giá: " + Utils.numberToText(gemCost), res.FONT.SOJI[20], 350, cc.TEXT_ALIGNMENT_CENTER);
