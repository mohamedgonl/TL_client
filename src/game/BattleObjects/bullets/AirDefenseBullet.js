var AirDefenseBullet = Bullet.extend({
    active: true,
    target: null,

    ctor: function (type, startPoint, target, damagePerShot, attackRadius, attackArea, initPos) {
        this._super(type, res_map.SPRITE.BODY.AIR_DEFENSE.BULLET, startPoint, target, damagePerShot, attackRadius, attackArea, initPos);
        ...
        this.actionExplose = fr.createActionByFrames(res_map.SPRITE.BODY.AIR_DEFENSE.HIT, {delayPerUnit: 0.1,});
